...
class CyclicChangeDetector(ChangeDetectorMkII):
    def __init__(
        self, translation_spec, cross_lambda, cycle_lambda, reg_lambda, **kwargs
    ):
        """
            Input:
        ...
        super(CyclicChangeDetector, self).__init__(translation_spec, **kwargs)
    ...
    def __call__(self, inputs, training=False):
        ...
        if training:
            ...
            retval = [x_hat, y_hat, x_cycle, y_cycle]
        else:
    ...
    def _train_step(self, x, y, clw):
        ...
        with tf.GradientTape() as tape:
            x_hat, y_hat, x_cycle, y_cycle = self((x, y), training=True)
...
if __name__ == "__main__":
    ...
    print("Initializing CyclicChangeDetector")
    cd = CyclicChangeDetector(TRANSLATION_SPEC, **LAMBDAS, **CONFIG)
    print("Training")
